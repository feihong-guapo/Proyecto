...
public class User implements Serializable {
    ...
    public User(int user_id, String nombre, String apellidos, String email, String account_type, int verified, int edad, String telefono, String ciudad, String direccion, String username,String rutaImg){
